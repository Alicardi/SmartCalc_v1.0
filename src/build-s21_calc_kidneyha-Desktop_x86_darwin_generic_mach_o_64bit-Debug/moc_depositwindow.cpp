...
static const qt_meta_stringdata_DepositWindow_t
    qt_meta_stringdata_DepositWindow = {
        {
            QT_MOC_LITERAL(0, 13),   // "DepositWindow"
            QT_MOC_LITERAL(14, 11),  // "thirdWindow"
            QT_MOC_LITERAL(26, 0),   // ""
            QT_MOC_LITERAL(27, 26)   // "on_pushButton_menu_clicked"

        },
        "DepositWindow\0thirdWindow\0\0"
...
void DepositWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c,
                                       int _id, void **_a) {
  if (_c == QMetaObject::InvokeMetaMethod) {
    ...
    int *result = reinterpret_cast<int *>(_a[0]);
    {
      ...
      if (*reinterpret_cast<_t *>(_a[1]) ==
          static_cast<_t>(&DepositWindow::thirdWindow)) {
        *result = 0;
        return;
      }
    }
...
const QMetaObject DepositWindow::staticMetaObject = {
    {QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
     ...
     qt_meta_data_DepositWindow, qt_static_metacall, nullptr,
     qt_incomplete_metaTypeArray<
         qt_meta_stringdata_DepositWindow_t,
...
// SIGNAL 0
void DepositWindow::thirdWindow() {
